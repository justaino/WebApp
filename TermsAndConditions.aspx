<%@ Page Title="" Language="C#" MasterPageFile="~/PrimaryMaster.Master" AutoEventWireup="true" CodeBehind="TermsAndConditions.aspx.cs" Inherits="E_Commerce_Website.TermsAndConditions" %>
    ...
    <div id="primary-content">
        <div class="wrapper">
            ...
            <ul>
                ...
                <li><strong>Company</strong> (referred to as either "the Company", "We", "Us" or "Our" in this Agreement) refers to PineApple Inc, 13/14 Aungier St, Saint Peter's, Dublin, D02 WC04.</li>
                ...
                <li><strong>Website</strong> refers to PineApple Inc, accessible from www.pineapple.ie</li>
            ...
            <ul>
                <li>By email: office@pineapple.ie</li>
                <li>By phone number: 0856787654</li>
            </ul>
        </div>
    </div>
</asp:Content>
